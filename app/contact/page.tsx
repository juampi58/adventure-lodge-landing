...
const contactLineStyles = "flex items-center mt-2 space-x-2 text-dark-600 dark:text-gray-400";

const contactLineIconStyles = "w-4 h-4";

const inputStyles = "w-full px-4 py-3 border-2 placeholder:text-gray-800 dark:text-white rounded-md outline-none dark:placeholder:text-gray-200 dark:bg-gray-900 focus:ring-4 border-gray-300 focus:border-gray-600 ring-gray-100 dark:border-gray-600 dark:focus:border-white dark:ring-0";
...
export default function Page() {
  ...
  <div className="bg-gray-50 dark:bg-gray-900" id="contact-page">
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 text-center" id='contact-header'>
        ...
        <p className="pt-6 pb-6 text-base max-w-2xl text-center m-auto dark:text-gray-400">
            Estamos acá para ayudarte. Llená el formulario, envianos un e-mail o llamanos.
        </p>
    </section>
    <div
        ...
        <section>
            <h2 className="text-lg font-bold dark:text-gray-100">Medios de contacto</h2>
            <div className={contactLineStyles}>
                <MapIcon className={contactLineIconStyles}/><span>Sauce, Corrientes</span>
            </div>
            <div className={contactLineStyles}>
            ...
            <PhoneIcon className={contactLineIconStyles}/>
                <a href="tel:11111111111">+54 1150119276</a>
            </div>
        </section>
        <form ref={form} onSubmit={sendEmail}>
            ...
            <div className="mb-5">
                ...
                <input id="email_address" type="email" placeholder="E-mail" 
                    className={inputStyles}
                    name="email"/>
            </div>
            <div className="mb-5">
                <label  className="">Fecha aproximadfa de tu visita</label>
