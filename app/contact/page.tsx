export default function Page() {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 text-center">
        ...
        <p className="pt-6 pb-6 text-base max-w-2xl text-center m-auto dark:text-gray-400">
            Tenés algo para decirnos? Estamos aquí para ayudarte. Llená el formulario o envianos un email o llamá por
        </p>
    </div>
    <div
        ...
        <div>
            <h2 className="text-lg font-bold dark:text-gray-100">Contactanos</h2>
            <p className="max-w-sm mt-4 mb-4 dark:text-gray-400">Tenés algo para decir?</p>
            <div className="flex items-center mt-8 space-x-2 text-dark-600 dark:text-gray-400">
                ...
                </svg><span>Sauce, Corrientes</span>
            </div>
        ...
        <div>
            <form>
                ...
                <div className="mb-5">
                    <label  className="sr-only">Fecha de reserva</label>
